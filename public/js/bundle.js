...
var bookTour = exports.bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(tourId) {
    var response, sessionId, _error$response, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        case 0:
          _context.p = 0;
          (0, _alerts.showAlert)('info', 'Redirecting to payment...');
          _context.n = 1;
          return _axios.default.get("/api/v1/bookings/checkout-session/".concat(tourId));
        case 1:
          response = _context.v;
          sessionId = response.data.session.id; // Redirect to Stripe Checkout
          _context.n = 2;
        ...
        case 3:
          _context.p = 3;
          _t = _context.v;
          console.error('Stripe Checkout Error:', _t);
          (0, _alerts.showAlert)('error', ((_error$response = _t.response) === null || _error$response === void 0 || (_error$response = _error$response.data) === null || _error$response === void 0 ? void 0 : _error$response.message) || _t.message || 'Something went wrong!');
        case 4:
          return _context.a(2);
      }
    }, _callee, null, [[0, 3]]);
